...
import {SqlPlanComponent} from '../../sql-plan/sql-plan.component';
...
describe('StageInfoComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      declarations: [ StageInfoComponent, PartitionInfoComponent, SqlPlanComponent, ScatterComponent ],
