...
describe('MonitorComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ ApplicationListingComponent, StageInfoComponent, FlameChartComponent, ScatterComponent,
        PartitionInfoComponent, SqlPlanComponent, DonutComponent, InitcapPipe, DateFormatPipe, SafePipe ],
      ...
      imports: [ MatSidenavModule, RouterTestingModule, MatIconModule, MatMenuModule, HttpClientTestingModule,
        BrowserAnimationsModule, MatTooltipModule, MatDialogModule, MatTabsModule, MatTableModule,
