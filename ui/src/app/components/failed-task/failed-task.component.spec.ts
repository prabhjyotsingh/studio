...
import {OutlierTasksComponent} from '../job-analysis/outlier-tasks/outlier-tasks.component';
...
describe('FailedTaskComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ FailedTaskComponent, OutlierTasksComponent, StageInfoComponent, FlameChartComponent,
        ScatterComponent, PartitionInfoComponent, SqlPlanComponent, DonutComponent, SunBurstComponent, LineChartComponent ],
