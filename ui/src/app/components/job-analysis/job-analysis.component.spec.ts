...
import {OutlierTasksComponent} from './outlier-tasks/outlier-tasks.component';
...
describe('JobAnalysisComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      declarations: [ JobAnalysisComponent, OutlierTasksComponent, StageInfoComponent, FlameChartComponent,
        ScatterComponent, PartitionInfoComponent, SqlPlanComponent ],
